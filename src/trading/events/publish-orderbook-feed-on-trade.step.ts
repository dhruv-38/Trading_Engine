...
import { TradeExecutedPayloadSchema, Order } from "../services/types";
import { OrderBook } from "../services/order-book";

export const config: EventConfig = {
    type: 'event',
    name: 'PublishOrderbookFeedOnTrade',
    description: 'Publish orderbook snapshots after trades',
...
export const handler: Handlers['PublishOrderbookFeedOnTrade'] = async (input, { state, streams, logger }) => {
    try {
